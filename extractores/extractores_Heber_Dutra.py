...
def extraerDatosFactura(pagina, empresa):
    ...
    factura[KEY.NUM_FACT] = pagina[4]
    factura[KEY.EMPRESA] = pagina[3]
    factura[KEY.NIF] = str(pagina[2]).upper()

    factura[KEY.FECHA_FACT] = pagina[1]
    factura[KEY.FECHA_OPER] = factura[KEY.FECHA_FACT]
    
    factura[KEY.BASE_IVA] = pagina[6]
    factura[KEY.TIPO_IVA] = pagina[7]
    factura[KEY.CUOTA_IVA] = pagina[8]
