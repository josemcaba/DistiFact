...
class Empresa:
    """
    Clase que representa una empresa con sus atributos.
    """
...
class EmpresaManager:
    ...
    def cargar_empresas(self, ruta_json: str) -> bool:
        """
    ...
    def obtener_empresa(self, id_empresa: int) -> Optional[Empresa]:
        """
    ...
    def listar_empresas(self) -> Dict[int, Empresa]:
        """
        Retorna el diccionario de empresas.
